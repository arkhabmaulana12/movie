package id.sch.smktelkom_mlg.privateassignment.xirpl407.movie.adapter;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl407.movie.R;
import id.sch.smktelkom_mlg.privateassignment.xirpl407.movie.model.Source;

/**
 * Created by ALAN on 14/05/2017.
 */
...
public class SourceAdapter extends RecyclerView.Adapter<SourceAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.sources_list, parent, false);
